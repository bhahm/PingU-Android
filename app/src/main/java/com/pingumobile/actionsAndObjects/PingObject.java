...
public class PingObject {
    ...
    public void sendPingObjToParse() {
        ...
        ParseObject pingInParse2 = new ParseObject("StoredPings");
        pingInParse2.put("pingTime", pingTime);
        pingInParse2.put("creator", "creator");
        pingInParse2.put("latitude", lat);
        pingInParse2.put("longitude", lng);
        pingInParse2.put("message", "message");
        pingInParse2.saveInBackground();
    }
